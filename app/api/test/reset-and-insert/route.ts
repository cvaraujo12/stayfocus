...
export async function POST() {
  try {
    ...
    await supabaseAdmin.from('medications').delete().neq('id', 'dummy')
    await supabaseAdmin.from('daily_routines').delete().neq('id', 'dummy')
    await supabaseAdmin.from('profiles').delete().neq('id', 'dummy')
